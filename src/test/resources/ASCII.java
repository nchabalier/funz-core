...
public class ASCII {
    ...
    public static String removeAccents(String s) {
        s = s.replaceAll("[ÃÅ¡ÃÂ©ÃÂªÃÂ«]", "e");
        s = s.replaceAll("[ÃÂ»ÃÂ¹]", "u");
        s = s.replaceAll("[ÃÂ¯ÃÂ®]", "i");
        s = s.replaceAll("[ÃÂ ÃÂ¢]", "a");
        s = s.replaceAll("ÃÂ", "o");
        s = s.replaceAll("ÃÂ§", "c");
        s = s.replaceAll("[ÃÂÃÂÃÂÃÂ]", "E");
        s = s.replaceAll("[ÃÂÃÂ]", "U");
        s = s.replaceAll("[ÃÂÃÂ]", "I");
        s = s.replaceAll("[ÃÂÃÂ]", "A");
        s = s.replaceAll("ÃÂ", "O");
